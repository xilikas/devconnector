...
router.post(
    ...
    (req, res) => {
        ...
        Profile.findOne({ user: req.user.id }).then(profile => {
            ...
            // Add to experience array of currently logged in user, then save
            // Using unshift to add experience to beginning of array
...
router.post(
    ...
    (req, res) => {
        ...
        Profile.findOne({ user: req.user.id }).then(profile => {
            ...
            // Add to education array of currently logged in user, then save
    ...
    (req, res) => {
        Profile.findOne({ user: req.user.id }).then(profile => {
            ...
            const removeIndex = profile.experience
                .map(item => item.id) // Getting an array of id's
                .indexOf(req.params.exp_id); // Matches it to the id passed in URL
